...
const array = [
  {
    ...
    description: "перевірка форсунок проходить на сучасному обладнанні. Перевірка за різними параметрами, в залежності від виробника.",
    picture: diagnostics,
  },
  {
    id: 2,
    title: "Демонтаж",
    description: "форсунки легко знімаються, але якщо на них утворюється окис - потрібні спеціальні інструменти. Складність впливає на ціну.",
    picture: dismantling,
  },
  {
    id: 3,
    title: "Комп’ютерна діагностика",
    description: "для усіх клієнтів проводимо безкоштовну комп’ютерну діаностику для покращення роботи та подальшої співпраці.",
    picture: computerDiagnostics,
  },
  {
    id: 4,
    title: "Відновлення дизельної апаратури",
    description: "виконуємо ремонт та заміняємо форсунки для легкових та комерційних автомобілів за вигідними цінами.",
    picture: restoration,
  },
]
